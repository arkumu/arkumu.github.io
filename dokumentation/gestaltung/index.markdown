...
Die Gestaltung der Seiten ist flexibel aufgebaut, um die langfristige Weiterentwicklung zu unterstützen. Das Design ist barrierearm, vollständig responsiv und nach dem Mobile-First-Prinzip entwickelt, so dass es auf allen Typen von Endgeräten optimal angezeigt wird. 

Die *Einstiegsseite* bietet verschiedene Zugangswege: ein einfaches Suchfeld, ein direkter Link zu den Projekten einzelner Hochschulen, sowie kuratierte sowie assoziative, spielerische Zugänge, die ein Stöbern und Entdecken von Inhalten ermöglichen.

Die *erweiterte Suche* ergänzt die Möglichkeiten durch zusätzliche Filtervarianten wie eine Sortierung und Filterung nach Zeitraum, Datum, Hochschule, Projektkategorie oder beteiligten Akteur:innen. Sie erlaubt den Wechsel zwischen unterschiedlichen Ergebnisansichten, so dass Projekte je nach Präferenz in verschiedenen Listenformaten dargestellt werden können. 
...
<div style="display: flex; justify-content: space-around; flex-wrap: wrap;">
  <div style="flex: 1 1 300px; margin: 10px; max-width: 300px; text-align: center;">
    <a href="/assets/images/Design-Entwurf-Startseite-ohne-Footer.png">
      <img src="/assets/images/Design-Entwurf-Startseite-ohne-Footer.png" 
  ...
  <div style="flex: 1 1 300px; margin: 10px; max-width: 300px; text-align: center;">
    <a href="/assets/images/Design-Entwurf_Projekt-Ansicht-ohne-Footer.png">
      <img src="/assets/images/Design-Entwurf_Projekt-Ansicht-ohne-Footer.png" 
