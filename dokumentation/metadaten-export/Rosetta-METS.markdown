...
* [1. Ordner- und Dateistruktur](#1-folder-and-file-structure)
* [2. Abschnitts-Übersicht](#2-section-overview)
* [3. METS-Wurzel-Element](#3-mets-root-element)
* [4. Intellektuelle Einheit: Beschreibende und rechtliche Metadaten](#4-itellectual-entity-descriptive-and-rights-metadata)
* [5. Dateien: Beschreibende und rechtliche Metadaten](#5-files-descriptive-and-rights-metadata)
* [6. Intellektuelle Einheit: Administrative und rechtliche Metadaten](#6-itellectual-entity-administrative-and-rights-metadata)
* [7. Representation: Administrative Metadaten](#7-representation-administrative-metadata)
* [8. Dateien: Administrative und rechtliche Metadaten](#8-files-entity-administrative-and-rights-metadata)
* [9. Datei-Sektion](#9-file-section)
...
&lt;record xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:dc="http://purl.org/dc/elements/1.1"&gt;
    &lt;dc:title&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project">Project</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#preferred-title">Preferred Title</a>&lt;/dc:title&gt;
&lt;/record&gt;
</pre>
...
<pre>
&lt;dc:identifier&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project">Project</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#arkumu-id">arkumu ID</a>&lt;/dc:identifier&gt;
</pre>
...
<pre>
&lt;dc:rights&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project">Project</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#rights-status">Rights Status</a>&lt;/dc:rights&gt;
...
<pre>
&lt;dc:title&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project">Project</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#preferred-subtitle">Preferred Subtitle</a>&lt;/dc:title&gt;
</pre>
...
Related Entity Class: [Project Type](https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-type)<br/>
Min-Max Occurence: 1-n

<pre>
&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-type">Project Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">German Name</a>(1)&lt;/dc:type&gt;
&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-type">Project Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-name">English Name</a>(1)&lt;/dc:type&gt;
&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-type">Project Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#wikidata-id">Wikidata ID</a>(1)&lt;/dc:type&gt;
</pre>
...
Related Entity Class: [Project Category](https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category)<br/>
Min-Max Occurence: 1-n<br/>
Note: This is an entry from a taxonomy. If a Project Category has a connection via [has broader project category](https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#has-broader-project-category) to another one, the broader category is set under the previous. Further, if there are several Project Categories stemming from the same broader one, only unique values should be set.

<pre>
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">German Name</a>(1)&lt;/dc:subject&gt;
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-name">English Name</a>(1)&lt;/dc:subject&gt;
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-synonym">German Synonym</a>(0-n)&lt;/dc:subject&gt;
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-synonym">English Synonym</a>(0-n)&lt;/dc:subject&gt;
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#wikidata-id">Wikidata ID</a>(1)&lt;/dc:subject&gt;
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#gnd-id">GND ID</a>(0-1)&lt;/dc:subject&gt;
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#aat-id">AAT ID</a>(0-1)&lt;/dc:subject&gt;
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#filmportalde-category-id">filmportal.de Category ID</a>(0-1)&lt;/dc:subject&gt;
</pre>
...
Related Entity Class: [Keyword](https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#keyword)<br/>
Min-Max Occurence: 0-n<br/>

<pre>
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#keyword">Keyword</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-wikidata-label">German Wikidata Label</a>(1)&lt;/dc:subject&gt;
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#keyword">Keyword</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-wikidata-label">English Wikidata Label</a>(1)&lt;/dc:subject&gt;
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#keyword">Keyword</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-wikidata-synonym">German Wikidata Synonym</a>(0-n)&lt;/dc:subject&gt;
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#keyword">Keyword</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-wikidata-synonym">English Wikidata Synonym</a>(0-n)&lt;/dc:subject&gt;
&lt;dc:subject&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#keyword">Keyword</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#wikidata-id">Wikidata ID</a>(1)&lt;/dc:subject&gt;
</pre>
...
Related Entity Class: [Project Description](https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category)<br/>
Min-Max Occurence: 0-n

<pre>
&lt;dc:description&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-description">Project Description</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#description-text">Description Text</a>(1)&lt;/dc:description&gt;
</pre>
...
Related Entity Class: [Event](https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event)<br/>
Min-Max Occurence: 0-n<br/>

<pre>
&lt;dc:title&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">German Name</a>(1)&lt;/dc:title&gt;
&lt;dc:title&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-name">English Name</a>(0-1)&lt;/dc:title&gt;
&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">German Name</a>(1)&lt;/dc:type&gt;
&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-name">English Name</a>(1)&lt;/dc:type&gt;
&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#germen-synonym">German Synonym</a>(0-n)&lt;/dc:type&gt;
&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-synonym">English Synonym</a>(0-n)&lt;/dc:type&gt;
&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#wikidata-id">Wikidata ID</a>(1)&lt;/dc:type&gt;
&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#gnd-id">GND ID</a>(0-1)&lt;/dc:type&gt;
&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#aat-id">AAT ID</a>(0-1)&lt;/dc:type&gt;
&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#lido-terminology-id">LIDO Terminology ID</a>(0-1)&lt;/dc:type&gt;
&lt;dc:date&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-begin">Event Begin</a>(1; if none given, the technical is taken)&lt;/dc:date&gt;
&lt;dc:date&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-begin">Event Begin</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#estimation">Estimation</a>(1; true or false)&lt;/dc:date&gt;
&lt;dc:date&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-end">Event End</a>(1; if none given, the technical is taken)&lt;/dc:date&gt;
&lt;dc:date&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-end">Event End</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#estimation">Estimation</a>(1; true or false)&lt;/dc:date&gt;
&lt;dc:contributor&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-end">Actor</a>(0-n)&lt;/dc:contributor&gt;
...
&lt;mets:dmdSec ID="FL[...]-dmd"&gt;
    &lt;mets:mdWrap MDTYPE="DC"&gt;
        &lt;mets:xmlData&gt;
            &lt;dc:record xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"&gt;
                &lt;dc:identifier&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.UUID&lt;/dc:identifier&gt;(1)
                &lt;dc:title&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#file-name">File Name</a>&lt;/dc:title&gt;(1)
		&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#genesis-type">Genesis Type</a>&lt;/dc:type&gt;(1)
		&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#media-type">Media Type</a>&lt;/dc:type&gt;(1)
		&lt;dc:type&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#mime-type">MIME Type</a>&lt;/dc:type&gt;(1)
		&lt;dc:description&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#significant-properties-german">Significant Properties (German)</a>&lt;/dc:description&gt;(0-1)
		&lt;dc:description&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties##significant-properties-english">Significant Properties (English)</a>&lt;/dc:description&gt;(0-1)
		&lt;dcterms:license&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object-licence">Digital Object Licence</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">German Name</a>&lt;/dcterms:license&gt;(1)
		&lt;dcterms:license&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object-licence">Digital Object Licence</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">English Name</a>&lt;/dcterms:license&gt;(1)
		&lt;dcterms:license&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object-licence">Digital Object Licence</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#uri">URI</a>&lt;/dcterms:license&gt;(1)
            &lt;/dc:record&gt;
        &lt;/mets:xmlData&gt;
    &lt;/mets:mdWrap&gt;
&lt;/mets:dmdSec&gt;
...
## 6. Itellectual Entity: Administrative and Rights Metadata

```Intellektuelle Einheit: Administrative und rechtliche Metadaten```
...
The Rights Metadata Section displays the Project's [Right Status](https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#rights-status). The ```section``` is always marked with```linkingRightsStatementIdentifier```, for preparing the linking to an external rights document outside of Rosetta. For Projects protected by German Urheberrecht und Leistungsschutzrecht, the ```record```s point to the German and English legal text of the "UrhG", and for free Projects, they could point to the [No Copyright - Other Known Legal Restrictions](https://rightsstatements.org/page/NoC-OKLR/1.0/?language=en) statement by [Rights Statements](https://rightsstatements.org/). The ```linkingRightsStatementIdentifier``` is always ```URI```, the ```linkingRightsStatementIdentifierValue``` contains the actual link.
...
In the Source Metadata Section, the URI identifiers of the Entity and Field Classes of the [Graph Model Implementation of the Data Model](https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties) are generally used as attributes. If necessary, this is extended by a language tag in accordance with ISO 639-2(B). A notable exception are the fields containing (authority file) links, which are all consistently marked with ```xml:type="dcterms:URI"```. This is primarily for technical reasons, so that they essentially function as separators between different entries in a Class, e.g. between two Keywords or Project Categories. In the Grails version, this made it easier to separate them for a possible XSD conversion. Of course, other names could also be found that serve the same purpose, e.g. always using the Entity Class first, then the Field Class, for the naming.
...
<pre>
&lt;dc:identifier xml:type="arkumu-ID"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project">Project</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#arkumu-id">arkumu ID</a>&lt;/dc:identifier&gt;
</pre>
...
<pre>
&lt;dc:rights xml:type="rights-status" xml:lang="ger"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project">Project</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#rights-status">Rights Status</a>&lt;/dc:rights&gt;
...
<pre>
&lt;dc:title xml:type="preferred-title" xml:lang="<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#preferred-title">Preferred Title</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#language">Language</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#iso639-2b-code">ISO 639-2(B) Code</a>"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project">Project</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#preferred-title">Preferred Title</a>&lt;/dc:title&gt;
</pre>
...
<pre>
&lt;dc:title xml:type="preferred-subtitle" xml:lang="<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#preferred-subtitle">Preferred Subtitle</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#language">Language</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#iso639-2b-code">ISO 639-2(B) Code</a>&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project">Project</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#preferred-subtitle">Preferred Subtitle</a>&lt;/dc:title&gt;
</pre>
...
<pre>
&lt;dc:type xml:type="project-type" xml:lang="ger"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-type">Project Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">German Name</a>(1)&lt;/dc:type&gt;
&lt;dc:type xml:type="project-type" xml:lang="eng"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-type">Project Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-name">English Name</a>(1)&lt;/dc:type&gt;
&lt;dc:type xml:type="dcterms:URI"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-type">Project Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#wikidata-id">Wikidata ID</a>(1)&lt;/dc:type&gt;
</pre>
...
<pre>
&lt;dc:subject xml:type="project-category" xml:lang="ger"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">German Name</a>(1)&lt;/dc:subject&gt;
&lt;dc:subject xml:type="project-category" xml:lang="ger"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-name">English Name</a>(1)&lt;/dc:subject&gt;
&lt;dc:subject xml:type="project-category-german-synonym" xml:lang="ger"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-synonym">German Synonym</a>(0-n)&lt;/dc:subject&gt;
&lt;dc:subject xml:type="project-category-english-synonym" xml:lang="eng"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-synonym">English Synonym</a>(0-n)&lt;/dc:subject&gt;
&lt;dc:subject xml:type="dcterms:URI"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#wikidata-id">Wikidata ID</a>(1)&lt;/dc:subject&gt;
&lt;dc:subject xml:type="dcterms:URI"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#gnd-id">GND ID</a>(0-1)&lt;/dc:subject&gt;
&lt;dc:subject xml:type="dcterms:URI"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#aat-id">AAT ID</a>(0-1)&lt;/dc:subject&gt;
&lt;dc:subject xml:type="dcterms:URI"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-category">Project Category</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#filmportalde-category-id">filmportal.de Category ID</a>(0-1)&lt;/dc:subject&gt;
</pre>
...
<pre>
&lt;dc:subject xml:type="keyword-wikidata-label" xml:lang="ger"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#keyword">Keyword</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-wikidata-label">German Wikidata Label</a>(1)&lt;/dc:subject&gt;
&lt;dc:subject xml:type="keyword-wikidata-label" xml:lang="eng"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#keyword">Keyword</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-wikidata-label">English Wikidata Label</a>(1)&lt;/dc:subject&gt;
&lt;dc:subject xml:type="keyword-wikidata-synonym" xml:lang="ger"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#keyword">Keyword</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-wikidata-synonym">German Wikidata Synonym</a>(0-n)&lt;/dc:subject&gt;
&lt;dc:subject xml:type="keyword-wikidata-synonym" xml:lang="eng"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#keyword">Keyword</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-wikidata-synonym">English Wikidata Synonym</a>(0-n)&lt;/dc:subject&gt;
&lt;dc:subject xml:type="dcterms:URI"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#keyword">Keyword</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#wikidata-id">Wikidata ID</a>(1)&lt;/dc:subject&gt;
</pre>
...
<pre>
&lt;dc:description xml:type="project-description" xml:lang="<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-description">Project Description</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#language">Language</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#iso639-2b-code">ISO 639-2(B) Code</a>"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project-description">Project Description</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#description-text">Description Text</a>(1)&lt;/dc:description&gt;
</pre>
...
<pre>
&lt;dc:title xml:type="event-name" xml:lang="ger"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">German Name</a>(1)&lt;/dc:title&gt;
&lt;dc:title xml:type="event-name" xml:lang="eng"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-name">English Name</a>(0-1)&lt;/dc:title&gt;
&lt;dc:type xml:type="event-type" xml:lang="ger"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">German Name</a>(1)&lt;/dc:type&gt;
&lt;dc:type xml:type"event-type" xml:lang="eng"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-name">English Name</a>(1)&lt;/dc:type&gt;
&lt;dc:type xml:type"event-type-synonym" xml:lang="ger"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#germen-synonym">German Synonym</a>(0-n)&lt;/dc:type&gt;
&lt;dc:type xml:type"event-type-synonym" xml:lang="eng"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#english-synonym">English Synonym</a>(0-n)&lt;/dc:type&gt;
&lt;dc:type xml:type"dcterms:URI"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#wikidata-id">Wikidata ID</a>(1)&lt;/dc:type&gt;
&lt;dc:type xml:type"dcterms:URI"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#gnd-id">GND ID</a>(0-1)&lt;/dc:type&gt;
&lt;dc:type xml:type"dcterms:URI"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#aat-id">AAT ID</a>(0-1)&lt;/dc:type&gt;
&lt;dc:type xml:type"dcterms:URI"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-type">Event Type</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#lido-terminology-id">LIDO Terminology ID</a>(0-1)&lt;/dc:type&gt;
&lt;dc:date xml:type="event-begin"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-begin">Event Begin</a>(1; if none given, the technical is taken)&lt;/dc:date&gt;
&lt;dc:date xml:type="event-begin-estimated"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-begin">Event Begin</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#estimation">Estimation</a>(1; true or false)&lt;/dc:date&gt;
&lt;dc:date xml:type="event-end"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-end">Event End</a>(1; if none given, the technical is taken)&lt;/dc:date&gt;
&lt;dc:date xml:type="event-end-estimated"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-end">Event End</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#estimation">Estimation</a>(1; true or false)&lt;/dc:date&gt;
&lt;dc:contributor xml:type="actor"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event-end">Actor</a>(0-n)&lt;/dc:contributor&gt;
...
## 7. Representation: Administrative Metadata

```Representation: Administrative Metadaten```
...
## 8. Files: Administrative and Rights Metadata

```Dateien: Administrative und rechtliche Metadaten```
...
The Administrative Section for the Files is similarly structured as the [Administrative Section for the Intellectual Entity](#6-itellectual-entity-administrative-and-rights-metadata), and always includes a section for technical metadata, rights and source metadata. There should be always one Administrative Metadata Section for each file transmitted. The ```objectType``` in the technical metadata must be ```FILE```, and via the ```generalFileCharacteristics``` the [File Name](https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#file-name) is transmitted. The ```linkingRightsStatementIdentifierValue``` must always be the [URI](https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#uri) of the [Digital Object Licence]() attached to the Object. For the source metadata, the same rules apply as the the Itellectual Object as well.
        ...
        &lt;mets:xmlData&gt;
            &lt;dnx xmlns="http://www.exlibrisgroup.com/dps/dnx"&gt;
                ...
                &lt;section id="generalFileCharacteristics"&gt;
                    &lt;record&gt;
                        &lt;key id="label"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#file-name">File Name</a>&lt;/key&gt;
                    &lt;/record&gt;
                &lt;/section&gt;
            &lt;/dnx&gt;
        &lt;/mets:xmlData&gt;
        ...
        &lt;mets:xmlData&gt;
            &lt;dnx xmlns="http://www.exlibrisgroup.com/dps/dnx"&gt;
                &lt;section id="linkingRightsStatementIdentifier"&gt;
                    &lt;record&gt;
                        &lt;key id="linkingRightsStatementIdentifier"&gt;URI&lt;/key&gt;
                        &lt;key id="linkingRightsStatementIdentifierValue"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object-licence">Digital Object Licence</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#uri">URI</a>&lt;/key&gt;
                    &lt;/record&gt;
                &lt;/section&gt;
            &lt;/dnx&gt;
        &lt;/mets:xmlData&gt;
...
&lt;mets:sourceMD ID="FL[...]-amd-source-dc"&gt;
    &lt;mets:mdWrap MDTYPE="DC"&gt;
        &lt;mets:xmlData&gt;
            &lt;dc:record xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"&gt;
                &lt;dc:identifier xml:type="Digital-Object-ID"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.UUID&lt;/dc:identifier&gt;
                &lt;dc:title xml:type="file-name"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#file-name">File Name</a>&lt;/dc:title&gt;
		&lt;dc:type xml:type="genesis-type"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#genesis-type">Genesis Type</a>&lt;/dc:type&gt;
		&lt;dc:type xml:type="media-type"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#media-type">Media Type</a>&lt;/dc:type&gt;
		&lt;dc:type xml:type="mimetype"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#mime-type">MIME Type</a>&lt;/dc:type&gt;
		&lt;dc:description xml:type="significant-properties-german"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#significant-properties-german">Significant Properties (German)</a>&lt;/dc:description&gt;(0-1)
		&lt;dc:description xml:type="significant-properties-english" &gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties##significant-properties-english">Significant Properties (English)</a>&lt;/dc:description&gt;(0-1)
		&lt;dcterms:license xml:lang="ger"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object-licence">Digital Object Licence</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">German Name</a>&lt;/dcterms:license&gt;
		&lt;dcterms:license xml:lang="eng"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object-licence">Digital Object Licence</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">English Name</a>&lt;/dcterms:license&gt;
		&lt;dcterms:license xml:type="dcterms:URI"&gt;<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object-licence">Digital Object Licence</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#uri">URI</a>&lt;/dcterms:license&gt;
            &lt;/dc:record&gt;
        &lt;/mets:xmlData&gt;
    &lt;/mets:mdWrap&gt;
&lt;/mets:SourceMD&gt;
...
&lt;mets:structMap ID="REP1-1" TYPE="LOGICAL"&gt;(1 for Preservation Master)
    &lt;mets:div LABEL="<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#project">Project</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#preferrd-title">Preferred Title</a>"&gt;(1)
        &lt;mets:div LABEL="<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#german-name">German Name</a>"&gt;[1-n]
            &lt;mets:div LABEL="Preservation Master"&gt;(1)
                &lt;mets:div LABEL="[folder name]"&gt;[0-n; displaying the folder structure if prevalent]
                    &lt;mets:div LABEL="<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#event">Event</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#digital-object">Digital Object</a>.<a href="https://gitlab.git.nrw/arkumu/arkumu-exchange-portal/-/wikis/data-model/classes-and-properties#file-name">File Name</a>" TYPE="FILE"&gt;[1-n]
                        &lt;mets:fptr FILEID="FL[...]"&gt;
                        &lt;/mets:fptr&gt;
                    &lt;/mets:div&gt;
                &lt;/mets:div&gt;
