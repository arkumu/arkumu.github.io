...
Es ist möglich, Dateien ohne den Umweg über den S3-Speicher direkt an das hbz zu liefern. Das hbz stellt dafür nach Absprache einen Zugang zum I/O-Server des Rosetta-Systems zur Verfügung.
