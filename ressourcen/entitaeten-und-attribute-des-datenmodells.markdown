...
| Lizenzstatus | License State | 1 | Eine Auswahl, welche Lizenz dieser Datei vergeben werden soll. Der Wert `1` entspricht der Lizenz Arkumu-A, der Wert `2` entspricht der Lizenz Arkumu-A+B, der Wert `3` entspricht der Lizenz Arkumu-A+B+C | 
