...
Urheberrechte schützen geistige Schöpfungen von Menschen, insbesondere Werke der Literatur, Kunst und Musik sowie Filmwerke. Eine der Hauptvoraussetzungen für das Entstehen des Schutzes ist die sogenannte „Schöpfungshöhe”.

Die Schöpfungshöhe ist das Mindestmaß an individueller, kreativer Leistung, das ein Werk erreichen muss, um urheberrechtlich geschützt zu sein. Damit sollen schutzfähige Leistungen von nicht geschützten alltäglichen, banalen und rein handwerklichen Leistungen abgegrenzt werden. Um das Mindestmaß zu erreichen, muss ein Werk eine ausreichende Originalität oder persönliche Prägung aufweisen. Dabei genügt auch schon eine geringe Schöpfungshöhe, solange das Werk eine persönliche geistige Schöpfung darstellt. 

Bloße Ideen, die noch nicht wahrnehmbar sind, sind nicht geschützt. Dabei muss die Idee nicht zwingend dauerhaft fixiert sein (z.B. schriftliche Aufzeichnung oder Tonaufzeichnung), es genügt bereits eine mündliche Wiedergabe einer anderen Person gegenüber.

Wenn ein Werk urheberrechtlich geschützt ist, stehen dem/der Urheber:in exklusive Rechte an der Veröffentlichung, Nutzung und Verwertung seines/ihres Werkes zu. Das Urheberrecht an einem Werk entsteht automatisch mit der Schöpfung, wenn die vorstehenden Voraussetzungen vorliegen. Eine Registrierung des Werks ist nicht erforderlich.

Das Urheberrecht schützt sowohl ideelle Interessen (Urheberpersönlichkeitsrechte wie z.B. Anspruch auf Namensnennung bei Veröffentlichungen des Werkes) als auch wirtschaftliche Interessen (Verwertungsrechte wie z.B. Vervielfältigungsrecht, Verbreitungsrecht, Aufführungsrecht, Vorführungsrecht, Senderecht).

Die Urheberpersönlichkeitsrechte sind nicht übertragbar, können aber vererbt werden. Die Verwertungsrechte können ganz oder teilweise anderen als Nutzungsrechte eingeräumt werden.

Der Schutz des Urheberrechts wird für 70 Jahre nach dem Tod der Urheberin/des Urhebers gewährt. Wenn mehrere Personen ein Werk gemeinsam geschaffen haben, ohne dass sich die einzelnen Teile gesondert verwerten lassen (sog. Miturheberschaft), bestimmt sich das Ende der Schutzfrist nach dem Tod der/des längstlebenden Urheberin/Urhebers. International können andere Schutzfristen gelten.

Bei Bearbeitungen eines Werkes kann auch ein dem Urheberrecht verwandtes Bearbeiter:innenrecht entstehen.
...
Leistungsschutzrechte schützen nicht die originäre schöpferische Leistung wie beim Urheberrecht, sondern künstlerische oder finanziell-organisatorische Leistungen von Personen, Unternehmen oder Institutionen. Wichtige Leistungsschutzrechte sind das Leistungsschutzrecht der ausübenden Künstler/innen, das Leistungsschutzrecht der Tonträgerherstellerin/des Tonträgerherstellers, das Leistungsschutzrecht der Filmherstellerin/des Filmherstellers und das Leistungsschutzrecht der Veranstalterin/des Veranstalters.

- **Inhaber:innen von Leistungsschutzrechten können insbesondere**
  ausübende Künstler:innen (z.B. darbietende Musiker:innen,
  Schauspieler:innen) und Ton- und Filmhersteller:innen sein. Bei
  Live-Musikaufnahmen kann auch noch das Leistungsschutzrecht der
  Veranstalterin:des Veranstalters entstehen.

- **Exemplarisch** wären das bei musikalischen Werken die Komposition
  und der Text. Bei Werken der Tanzkunst wäre es die Choreografie und
  bei Werken der angewandten Kunst die künstlerische Gestaltung von
  Gebrauchsgegenständen.

Die **Schutzdauern bei Leistungsschutzrechten** sind unterschiedlich und berechnen sich ausgehend von dem Veröffentlichungs- oder Herstellungszeitpunkt. Bei musikalischen Darbietungen und Tonaufnahmen beträgt die Schutzfrist 70 Jahre nach Veröffentlichung oder falls die Darbietung/Tonaufnahme 50 Jahre lang unveröffentlicht war, dann schon 50 Jahre nach Herstellung. Dadurch kann es vorkommen, dass Tonaufnahmen bis zu 120 Jahre nach Herstellung geschützt sein können (Beispiel: bei einer Veröffentlichung 49 Jahre nach Herstellung beginnt die 70-jährige Schutzfrist zu laufen, so dass der Schutz dann erst 119 Jahre nach Herstellung endet).

Das Leistungsschutzrecht der Filmherstellerin/des Filmherstellers endet 50 Jahre nach Veröffentlichung bzw. nach Herstellung, das Leistungsschutzrecht der Veranstalterin/des Veranstalters bereits 25 Jahre nach Veröffentlichung bzw. Herstellung der Tonaufzeichnung.
...
Die **Persönlichkeitsrechte** umfassen die Rechte jedes Menschen, über
...
Das Recht am eigenen Bild ist ein besonderes Persönlichkeitsrecht, das im Kunsturhebergesetz (KUG) geregelt ist. Das Verhältnis des KUG zur Datenschutzgrundverordnung (DSGVO) ist nicht abschließend geklärt. Die deutschen Gerichte haben jedoch das KUG für den journalistischen Bereich als Ausnahme gemäß Art. 85 Abs. 2 DSGVO von einigen Regelungen der DSGVO gesehen. Für den künstlerischen Bereich gibt es dazu noch keine Urteile, aber es ist recht wahrscheinlich, dass die Gerichte diesen Bereich ähnlich sehen.

- **Grundsatz der Einwilligung:** Die Verbreitung oder öffentliche
  Zurschaustellung eines **erkennbaren** Bildnisses einer Person
  erfordert grundsätzlich deren **Einwilligung**.

- **Beweislast:** Kunstschaffende tragen die Beweislast für den Umfang
  der erteilten Einwilligung. Daher ist eine **schriftliche** Fixierung
  des Zwecks und Umfangs der Nutzung dringend empfohlen.
...
- **Minderjährige:** Hier müssen in der Regel **beide gesetzlichen Vertreter:innen** (meist Elternteile) einwilligen. Ab einer gewissen **Einsichtsfähigkeit** (i. d. R. ab 12 - 14 Jahren) muss zusätzlich der/die Minderjährige selbst zustimmen.
...
- **Das Allgemeine Persönlichkeitsrecht** schützt die Achtung und freie Entfaltung der Persönlichkeit. Schutzbereiche des allgemeinen Persönlichkeitsrechts sind insbesondere Bereiche wie Privatsphäre, Ehre, Recht am eigenen Bild, Recht am eigenen Namen und informationelle Selbstbestimmung.

	- **Verletzung:** Liegt zum Beispiel vor, wenn Aufnahmen ohne vertragliche Vereinbarung für **materielle Zwecke** (insbesondere **Werbezwecke**) genutzt werden.

- **Versteckte/Heimliche Filmaufnahmen:** Das Herstellen ist grundsätzlich **unzulässig** und kann strafbar sein (§ 201a StGB). Eine Zulässigkeit ist nur in engen Grenzen (z. B. Unkenntlichmachung bei journalistischen Zwecken oder **überragendes öffentliches Interesse**) möglich.
...
Der Begriff **Pastiche** wurde 2021 neu in das deutsche Urheberrecht in § 51a UrhG aufgenommen und ist für die bildende Kunst sowie für das **Sampling** relevant.
...
Das Zitatrecht ist eine der ältesten und wichtigsten Schranken des Urheberrechts und gilt für alle Werkarten (Text, Bild, Film, Musik).
...
Neben den bereits erwähnten Schranken Zitat und Pastiche gibt es noch folgende Schranken, die bei der Erstellung eines Werks, in dem andere vorbestehende Werke erkennbar sind, bedeutsam sein können:

- Unwesentliches Beiwerk (§ 57 UrhG): regelt die Nutzung von Werken, die beiläufig oder zufällig in dem neuen Werk erkennbar sind (z.B. ein Plakat auf einem Foto oder auf Filmaufnahmen, Musik im Hintergrund bei Tonaufnahmen)
...
Potenzielle Markenrechtsverletzungen liegen vor bei:

- **Zuordnungsverwirrung (Fake)**: Die Nutzung suggeriert, dass die Marke eine:n andere:n Rechtsinhaber:in hat als in der Realität. Die gezeigte Marke muss der:dem tatsächlichen Markeninhaber:in zugeordnet werden können.

- **Negativer Kontext**: Die Darstellung der Marke erfolgt in einem negativen Kontext, wie zum Beispiel bei Verächtlichmachung, beleidigendem Kontext oder nicht mehr sachgemäßer Kritik.

- **Übermäßige Inszenierung**: Die Marke wird übermäßig im Film inszeniert.

- **Werbung für den eigenen Film**: Die Marke wird zur Werbung für den eigenen Film genutzt.

- **Ausnutzung des Images**: Das Image der Marke wird für den eigenen Film ausgenutzt.

- **Werbliche Herausstellung von Requisiten**: Marken, die als Requisiten genutzt werden, dürfen nicht werblich herausgestellt werden.

**Mögliche Ausnahme:**

- **Satire/Parodie**: Eine satirische oder parodistische Nutzung kann zulässig sein, wenn sich die Satire bzw. Parodie mit dem Produkt oder der Werbung für das Produkt auseinandersetzt.

**Abwägung der Interessen** In problematischen Fällen muss stets eine **Abwägung zwischen den Interessen und (Grund-)Rechten** der Markenrechtsinhaber:innen und den Interessen und (Grund-)Rechten der Urheber:innen/Filmhersteller:innen vorgenommen werden.

Marken können in unterschiedlicher Form vorkommen, wie zum Beispiel:

- **Wortmarken** (z. B. NIVEA)

- **Bildmarken** (z. B. Logo der deutschen Bank)

- **Wort-/Bild-Marken** (z. B. VW-Zeichen)

- **Hörmarken** (z. B. Jingles, musikalische Erkennungsmelodien, aber auch Klingeltöne wie z. B. TELEKOM)

- **Farbmarken**:

	- konturlos/einfarbig (z. B. Telekom: Magenta)

	- mehrfarbig (z. B. ARAL: blau/weiß)

- **Dreidimensionale Marken** (z. B. Rolls-Royce: Emily, Michelin-Männchen)
...
Daher lassen sich Hochschulen für diese Zwecke vertraglich nicht-exklusive (= einfache) Nutzungsrechte einräumen.
...
- Aus rechtlicher Sicht kann die Webseite von arkumu.nrw als großer, bibliothekarischer “Zettelkasten” verstanden werden

- Dieser “Zettelkasten” kann als Erweiterung bestehender, öffentlich zugänglicher “Zettelkasten” gesehen werden, wie es z.B. ein bestehender, öffentlich einsehbarer Bibliothekskatalog ist

- Der Speicher, auf dem alles, was auf arkumu.nrw sichtbar bzw. nicht-öffentlich gespeichert wird, ist ein erweiterter Speicher der Hochschulen. Die Daten werden nicht verändert. Jede Hochschule hat einen “eigenen” Platz im Speicher, auf den keine andere Hochschule Zugriff hat.
...
- **Bilder, Videos, Sounds**, usw. (digitale Objekte) dürfen nicht ohne vorherige Rechteklärung bzw. -einholung veröffentlicht werden

- für digitale Objekte bedarf es pro Hochschule unterschiedliche Vorgehen

- je nachdem, was in den einzelnen Hochschulregelungen festgelegt ist (z.B. bei der **BA-Anmeldung,** in der **Prüfungsordnung,** im **Projektvertrag** oder in der **Studienordnung**) festgelegt ist, können unter Umständen auch Bilder/Videos/Sounds etc. veröffentlicht werden

- **Sonderfall**: Handelt es sich um ein Plakat oder eine Postkarte einer Hochschule, in der eine Veranstaltung beworben wird, muss ggf. Rücksprache mit der Abteilung für Öffentlichkeitsarbeit/Gestaltungsabteilung Rücksprache gehalten werden, um zu klären, ob es bestehende Rechte gibt, die einem Veröffentlichen entgegenstehen.
